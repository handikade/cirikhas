      ...
      <div class="col-md-12">
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <!-- Button Tambah Bank -->
                <a href="#" data-toggle="modal" data-target="#tambah-bank" class="btn btn-primary waves-effect waves-light">
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class=box-button>
                                              <a href="#" data-toggle="modal" data-target="#edit-bank-{{ $i }}" class="btn btn-icon waves-effect waves-light btn-success m-b-5">
                                                <i class="fa fa-pencil"></i> Edit
                                              </a>

                                              @include('admin.bank.modal_edit')
              ...
              <!-- Modal Tambah Bank -->
                @include('admin.bank.modal_tambah')
              <!-- Akhir Modal Tambah bank -->
